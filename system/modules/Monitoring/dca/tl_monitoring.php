...
(
  ...
  (
    ...
    (
      ...
      (
        ...
        'attributes'          => 'target="_blank" onclick="Backend.openModalIframe({\'width\':765,\'title\':\'' . (isset($GLOBALS['TL_LANG']['tl_monitoring']['showPage'][0]) ? $GLOBALS['TL_LANG']['tl_monitoring']['showPage'][0] : '') . '\',\'url\':this.href});return false"'
      ),
      'checkOne' => array
      (
  ...
  (
    ...
    'last_test_response_time' => array
    (
      'label'                   => &$GLOBALS['TL_LANG']['tl_monitoring']['last_test_response_time'],
      'exclude'                 => true,
      'sorting'                 => true,
      'default'                 => '0',
      'inputType'               => 'text',
...
class tl_monitoring extends Backend
{
  ...
  public function deleteLastTestValues($value, DataContainer $dc)
  {
    if ($value != $dc->activeRecord->url)
    {
      ...
      $arrSet['last_test_response_time'] = 0;
