...
(
  ...
  'palettes' => array
  (
    'default'                     => '{result_legend},date,type,status,response_time,repetitions,response_string;{comment_legend},comment'
  ),
  ...
  (
    ...
    'response_time' => array
    (
      'label'                   => &$GLOBALS['TL_LANG']['tl_monitoring_test']['response_time'],
      'exclude'                 => true,
      'sorting'                 => true,
      'inputType'               => 'text',
